    ...
    <div className="[--shadow:rgba(60,64,67,0.3)_0_1px_2px_0,rgba(60,64,67,0.15)_0_2px_6px_2px] w-4/5 h-auto rounded-2xl bg-white [box-shadow:var(--shadow)] max-w-[300px]">
      <div className="flex flex-col items-center justify-between pt-9 px-6 pb-6 relative">
        ...
        <p className="w-full mb-4 text-sm text-justify">
          ...
          <a className="mb-2 text-sm cursor-pointer font-semibold transition-colors hover:text-sky-500 underline underline-offset-2 text-sky-600">Privacy Policy</a>
        </p>
        <button className="mb-2 text-sm mr-auto text-sky-600 cursor-pointer font-semibold transition-colors hover:text-sky-500 hover:underline underline-offset-2">
          More Options
        </button>
        <button className="absolute font-semibold right-6 bottom-6 cursor-pointer py-2 px-8 w-max break-keep text-sm rounded-lg transition-colors text-white bg-sky-600 hover:bg-sky-700" type="button">
          Accept
        </button>
      </div>
    </div>
